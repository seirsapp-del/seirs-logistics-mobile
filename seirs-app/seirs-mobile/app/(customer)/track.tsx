...
const STATUS_CONFIG: Record<string, {
  ...
  pending:    { label: 'Finding Driver',   step: 1, gradient: ['#00C2FF', '#0095CC'], icon: 'search' },
  assigned:   { label: 'Driver Assigned',  step: 2, gradient: ['#F4600C', '#B84208'], icon: 'navigate' },
  picked_up:  { label: 'Package Picked Up',step: 3, gradient: ['#D95209', '#8F3206'], icon: 'cube' },
  ...
  cancelled:  { label: 'Cancelled',        step: 0, gradient: ['#71717A', '#52525B'], icon: 'close-circle' },
};
