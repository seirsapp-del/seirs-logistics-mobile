/**
 * Promoted out of the per-app constants folders on 2026-09-01, when the
 * driver app needed the list too. Three identical copies of the canonical
 * names that pricing zones, inter-state surcharges and reporting all key
 * off is three chances for them to drift.
 *
