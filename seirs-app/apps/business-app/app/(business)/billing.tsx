...
const styles = StyleSheet.create({
  ...
  heroLabel:    { fontSize: 12, fontWeight: '700', letterSpacing: 0.6 },
  heroValue:    { fontSize: 30, fontWeight: '800', marginTop: 6 },
  heroSub:      { fontSize: 14, marginTop: 4 },
  sectionTitle: { fontSize: 12, fontWeight: '700', letterSpacing: 0.6, marginTop: 18, marginBottom: 8, marginLeft: 4 },
  ...
  footNote:     { fontSize: 13, lineHeight: 17, marginTop: 16, paddingHorizontal: 4 },
});
