...
const styles = StyleSheet.create({
  ...
  introSub:  { fontSize: 13, lineHeight: 17 },
  ...
  dismissBtnText:{ fontSize: 14, color: '#16A34A', fontWeight: '600' },
  ...
  modePill:  { fontSize: 11, fontWeight: '800', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 4 },
  keyName:   { flex: 1, fontSize: 15, fontWeight: '700' },
  revokedText:{ fontSize: 11, fontWeight: '800', color: '#DC2626' },
  keyRow:    { flexDirection: 'row', alignItems: 'center', gap: 8, padding: 10, borderRadius: 8 },
  publicMonospace: { flex: 1, fontFamily: Platform.OS === 'ios' ? 'Courier' : 'monospace', fontSize: 13 },
