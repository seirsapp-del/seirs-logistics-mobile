...
const styles = StyleSheet.create({
  ...
  storeAddr: { fontSize: 12, marginTop: 2 },
  bucket:    { fontSize: 11, fontWeight: '700', marginTop: 4 },

  storeRecap:     { flexDirection: 'row', alignItems: 'center', gap: 8, padding: 12, borderRadius: 10, borderWidth: 1 },
  storeRecapText: { flex: 1, fontSize: 13, fontWeight: '600' },
  ...
  codeLabel:   { fontSize: 10, fontWeight: '700', letterSpacing: 1, marginTop: 4 },
  codeBig:     { fontSize: 20, fontWeight: '800', letterSpacing: 1.5 },
  codeMid:     { fontSize: 16, fontWeight: '700', letterSpacing: 2 },
  receiptHint: { fontSize: 12, textAlign: 'center', marginTop: 6, lineHeight: 17 },
  ...
  doneLink:       { fontSize: 13, textDecorationLine: 'underline', marginTop: 4 },
});
