...
const styles = StyleSheet.create({
  ...
  linkText:    { fontSize: 15, color: '#3A7BD5', fontWeight: '600', textAlign: 'center', marginTop: 8 },
  ...
  cardLabel:   { fontSize: 12, fontWeight: '700', color: '#6B7280', letterSpacing: 0.8 },
  cardValue:   { fontSize: 18, fontWeight: '700', color: '#0F2B4C' },
  cardSub:     { fontSize: 15, color: '#6B7280' },
  cardSubtle:  { fontSize: 15, color: '#374151', lineHeight: 20 },
  ...
  warnText:    { color: '#92400E', fontSize: 13, fontWeight: '600', flex: 1 },

  fieldLabel:  { fontSize: 14, fontWeight: '700', color: '#0F2B4C' },
  helperText:  { fontSize: 13, color: '#6B7280', lineHeight: 17 },
  ...
  methodTitle:      { fontSize: 15, fontWeight: '700', color: '#0F2B4C', marginBottom: 2 },
  methodSub:        { fontSize: 13, color: '#6B7280', lineHeight: 17 },
  ...
  photoHint:   { fontSize: 14, color: '#6B7280', textAlign: 'center', paddingHorizontal: 24 },
  ...
  secondaryBtnText:{ color: '#3A7BD5', fontWeight: '600', fontSize: 15 },
