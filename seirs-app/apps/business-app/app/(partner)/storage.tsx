...
const styles = StyleSheet.create({
  ...
  summaryLabel:{ color: 'rgba(255,255,255,0.5)', fontSize: 12, fontWeight: '700', letterSpacing: 0.8 },
  summaryAmount:{ color: '#fff', fontSize: 28, fontWeight: '800', marginTop: 6 },
  summarySub: { color: 'rgba(255,255,255,0.7)', fontSize: 13, marginTop: 6 },
  ...
  dropCode:   { fontSize: 12, fontFamily: 'monospace', marginTop: 2 },
  tierBadge:  { fontSize: 12, fontWeight: '700', borderWidth: 1, borderRadius: 999, paddingHorizontal: 10, paddingVertical: 3 },
  ...
  midLabel:   { fontSize: 10, fontWeight: '700', letterSpacing: 0.5 },
  midValue:   { fontSize: 15, fontWeight: '700' },
  tierSub:    { fontSize: 12, fontWeight: '600', textAlign: 'center' },
