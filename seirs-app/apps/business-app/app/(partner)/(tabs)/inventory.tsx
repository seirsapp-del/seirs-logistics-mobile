...
const styles = StyleSheet.create({
  ...
  tab:         { paddingHorizontal: 12, height: 34, justifyContent: 'center', borderRadius: 17, borderWidth: 1 },
  tabText:     { fontSize: 12, fontWeight: '600', textTransform: 'capitalize', lineHeight: 16 },
  ...
  recipient:   { fontSize: 14, marginTop: 2 },
  ...
  collectBtnText: { color: '#fff', fontSize: 13, fontWeight: '700' },
