...
export default function TripDetailsScreen() {
  ...
  const trip = {
    ...
    driver:         raw.driver ? {
      ...
      rating:       Number(raw.driver.rating ?? 5),
      trips:        Number(raw.driver.totalDeliveries ?? raw.driver.trips ?? 0),
      color:        raw.driver.vehicleColor ?? raw.driver.color ?? '',
      vehicle:      raw.driver.vehicleModel ?? raw.driver.vehicle ?? raw.driver.vehicleType ?? '',
    } : null,
