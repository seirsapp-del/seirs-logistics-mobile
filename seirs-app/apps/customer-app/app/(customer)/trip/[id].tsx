              ...
              <View style={styles.driverRow}>
                ...
                {isActive && (
                  <View style={styles.driverActions}>
                    ...
                    <Pressable
                      style={[styles.driverActionBtn, { backgroundColor: isDark ? '#001020' : '#DBEAFE', borderColor: theme.primary }]}
                      onPress={() => router.push({ pathname: '/(customer)/call', params: { driverId: trip.driver!.id } })}
                    >
