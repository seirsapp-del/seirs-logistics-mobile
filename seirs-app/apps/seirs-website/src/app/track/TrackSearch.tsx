 ...
 *
 * Split out of page.tsx on 2026-08-23: the route was 'use client' end to
 * end, so it could not export metadata and the one page recipients search
 * for inherited the generic site title.
 */
