/**
 * Driver messages inbox, ported from the business app's MessagesInbox
...
interface MessagesInboxProps {
  /** Route prefix for a tapped thread, e.g. `/(driver)/messages`. */
  threadRoutePrefix: string;
  /** Route prefix for support tickets, e.g. `/(driver)/support`. */
