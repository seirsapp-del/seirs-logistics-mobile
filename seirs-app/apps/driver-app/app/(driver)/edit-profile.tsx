...
// Spec V8 — driver standalone profile editor. Mirrors the customer
// version. Doesn't expose vehicle fields here — those live on the KYC
// re-submission flow because they require document re-verification.
